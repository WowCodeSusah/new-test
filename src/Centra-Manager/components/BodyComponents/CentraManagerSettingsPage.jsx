    ...
    <div className='CentraManagerAddNewContainer'>
        <form className='CentraManagerAddNewFormContainer'>
            <div style={{marginTop: '10px'}}>
                ...
                <CentraManagerDropDown listOption={["English", "Indonesia"]}/>
            </div>
            <div className='CentraManagerSettingPagePasswordText'>Change Password</div>
            <div style={{marginTop: '10px'}}>
                <div className='CentraManagerAddNewSubText'>Old Password</div>
                <CentraManagerEditPassword label={'Old Password'}/>
            </div>
            <div style={{marginTop: '10px'}}>
                <div className='CentraManagerAddNewSubText'>New Password</div>
                <CentraManagerEditPassword label={"Enter New Password"}/>
            </div>
            <div style={{marginTop: '10px'}}>
                <div className='CentraManagerAddNewSubText'>Repeat Password</div>
